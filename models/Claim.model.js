...
const ClaimSchema = mongoose.Schema({
  ...
  date_full_claim_request_received: {
    type: Date,
    required: false,
    unique: false,
  },
  ...
  date_of_claim_payment: { type: Date, required: false},
  // total_paid_out: { type: Number, required: false, unique: false },
   total_paid_out: { type: Number, required: false },
  createdAt: Date,
  updatedAt: Date,
});
